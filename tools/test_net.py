...
if __name__ == '__main__':
  ...
  elif args.net == 'res101_mask':
    net = resnet_mask(batch_size=1, num_layers=101)
  elif args.net == 'res152':
    net = resnetv1(batch_size=1, num_layers=152)
  elif args.net == 'res101_C4':
    net = resnet_C4(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=101)
  elif args.net == 'res101_C3-C4':
